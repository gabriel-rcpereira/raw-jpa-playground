package com.grcp.jpa.playground.relationship.simple;
...
import com.grcp.jpa.playground.relationship.simple.repository.AuthorRepository;
import com.grcp.jpa.playground.relationship.simple.repository.BookRepository;
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        authorRepository.save(author)
                .ifPresent(saved -> System.out.println("Saved author: " + saved));
